...
namespace ru_text_spam_detector_ml.net.MachineLearn;

public partial class AntiWorkSpam
{
    /// <summary>
    /// model input class for AntiWorkSpam.
    /// </summary>
    ...
    {
        [LoadColumn(0)] [ColumnName(@"Value")] public string Value { get; set; }
    ...
    /// <summary>
    /// model output class for AntiWorkSpam.
    /// </summary>
    ...
    {
        [ColumnName(@"Value")] public float[] Value { get; set; }

        [ColumnName(@"IsSpam")] public uint IsSpam { get; set; }
    ...
    private static string MLNetModelPath = Path.GetFullPath("AntiWorkSpam.mlnet");
    ...
    private static IEnumerable<string> GetLabels(ModelOutput result)
    {
        ...
        {
            throw new Exception(
                "IsSpam column not found. Make sure the name searched for matches the name in the schema.");
        }
