...
namespace Ru_text_spam_detector_ml_net
{
    public partial class RuSpamMl
    {
        public const string RetrainFilePath =  @"C:\Users\kulagin\Desktop\dataset30.09.2024.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"Message",outputColumnName:@"Message")      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.LbfgsMaximumEntropy(new LbfgsMaximumEntropyMulticlassTrainer.Options(){L1Regularization=0.048309837F,L2Regularization=0.03125F,LabelColumnName=@"IsSpam",FeatureColumnName=@"Features"}))      
